    ...
    module Compiler = struct
      module rec Version : sig
        ...
        let to_proto =
          ...
          let spec = Serialize.C.( basic_opt (1, int32_int) ^:: basic_opt (2, int32_int) ^:: basic_opt (3, int32_int) ^:: basic_opt (4, string) ^:: nil ) in
        ...
        let from_proto =
          ...
          let spec = Deserialize.C.( basic_opt (1, int32_int) ^:: basic_opt (2, int32_int) ^:: basic_opt (3, int32_int) ^:: basic_opt (4, string) ^:: nil ) in
      ...
      and CodeGeneratorRequest : sig
        ...
        let to_proto =
          ...
          let spec = Serialize.C.( repeated (1, string, not_packed) ^:: basic_opt (2, string) ^:: repeated (15, (message (fun t -> Imported'modules.Descriptor.Google.Protobuf.FileDescriptorProto.to_proto t)), not_packed) ^:: basic_opt (3, (message (fun t -> Version.to_proto t))) ^:: nil ) in
          let serialize = Serialize.serialize [] (spec) in
          fun t -> apply ~f:serialize t
        ...
        let from_proto =
          ...
          let spec = Deserialize.C.( repeated (1, string, not_packed) ^:: basic_opt (2, string) ^:: repeated (15, (message (fun t -> Imported'modules.Descriptor.Google.Protobuf.FileDescriptorProto.from_proto t)), not_packed) ^:: basic_opt (3, (message (fun t -> Version.from_proto t))) ^:: nil ) in
          let deserialize = Deserialize.deserialize [] spec constructor in
          fun writer -> deserialize writer |> PResult.open_error
      ...
      and CodeGeneratorResponse : sig
        ...
        and File : sig
          ...
          let to_proto =
            ...
            let spec = Serialize.C.( basic_opt (1, string) ^:: basic_opt (2, string) ^:: basic_opt (15, string) ^:: nil ) in
            let serialize = Serialize.serialize [] (spec) in
            fun t -> apply ~f:serialize t
          
          let from_proto =
            let constructor = fun _extensions name insertion_point content -> { name; insertion_point; content } in
            let spec = Deserialize.C.( basic_opt (1, string) ^:: basic_opt (2, string) ^:: basic_opt (15, string) ^:: nil ) in
            let deserialize = Deserialize.deserialize [] spec constructor in
            fun writer -> deserialize writer |> PResult.open_error
        ...
        let to_proto =
          ...
          let spec = Serialize.C.( basic_opt (1, string) ^:: basic_opt (2, uint64_int) ^:: repeated (15, (message (fun t -> CodeGeneratorResponse.File.to_proto t)), not_packed) ^:: nil ) in
          let serialize = Serialize.serialize [] (spec) in
          fun t -> apply ~f:serialize t
        
        let from_proto =
          let constructor = fun _extensions error supported_features file -> { error; supported_features; file } in
          let spec = Deserialize.C.( basic_opt (1, string) ^:: basic_opt (2, uint64_int) ^:: repeated (15, (message (fun t -> CodeGeneratorResponse.File.from_proto t)), not_packed) ^:: nil ) in
          let deserialize = Deserialize.deserialize [] spec constructor in
          fun writer -> deserialize writer |> PResult.open_error
